...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        previous_frame_button->setGeometry(QRect(230, 410, 51, 31));
        ...
        play_button->setGeometry(QRect(290, 410, 51, 31));
...
"}"));
        ...
        undo_button->setGeometry(QRect(570, 410, 31, 31));
        ...
        label_2->setGeometry(QRect(570, 390, 71, 16));
        ...
        carryOverBox->setGeometry(QRect(510, 450, 101, 20));
        carryOverBox->setChecked(true);
        scrollArea = new QScrollArea(centralWidget);
        scrollArea->setObjectName(QStringLiteral("scrollArea"));
        scrollArea->setGeometry(QRect(20, 460, 479, 89));
        scrollArea->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents_2 = new QWidget();
        scrollAreaWidgetContents_2->setObjectName(QStringLiteral("scrollAreaWidgetContents_2"));
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 477, 87));
        horizontalLayoutWidget = new QWidget(scrollAreaWidgetContents_2);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(0, 0, 481, 101));
