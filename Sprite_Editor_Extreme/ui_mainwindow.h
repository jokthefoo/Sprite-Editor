...
"}"));
        ...
        framesBox->setGeometry(QRect(30, 400, 111, 41));
        ...
        carryOverBox->setGeometry(QRect(560, 510, 101, 20));
        carryOverBox->setChecked(true);
        scrollArea = new QScrollArea(centralWidget);
        scrollArea->setObjectName(QStringLiteral("scrollArea"));
        scrollArea->setGeometry(QRect(20, 450, 521, 111));
        ...
        horizontalLayoutWidget->setGeometry(QRect(0, 0, 481, 91));
